...
namespace FitraLife.Services
{
    public class GeminiService : IGeminiService
    {
        ...
        public async Task<string> GenerateMealPlanAsync(string dietType, int calories, string allergies)
        {
            var prompt = $@"
                        Generate a one-day meal plan for a user with these details:
                        - Diet Type: {dietType}
                        ...
                        ""meals"": [
                            {{ ""type"": ""Breakfast"", ""name"": ""string"", ""calories"": 0, ""description"": ""string"" }},
                            {{ ""type"": ""Lunch"", ""name"": ""string"", ""calories"": 0, ""description"": ""string"" }},
                            {{ ""type"": ""Dinner"", ""name"": ""string"", ""calories"": 0, ""description"": ""string"" }},
                            {{ ""type"": ""Snack"", ""name"": ""string"", ""calories"": 0, ""description"": ""string"" }}
                        ]
                        }}
                        ";
